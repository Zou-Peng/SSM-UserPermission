                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">父菜单</th>
                                <th class="sorting_desc sorting_desc_disabled">权限URL</th>
                                <th class="sorting">权限等级</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="p">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/permission/toupdate?id=${p.permissionId}"
...
<%--                </div>--%>
                ...
                <jsp:include page="pages.jsp">
                    <jsp:param name="pageUrl" value="/user/findByPage"/>
                </jsp:include>
            </div>
