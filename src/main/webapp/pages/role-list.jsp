                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/toupdate?id=${role.roleId}"
                                           class="btn bg-olive btn-xs">修改</a>
                                        <a href="${pageContext.request.contextPath}/role/toRolePermission?id=${role.roleId}"
                                           class="btn bg-olive btn-xs">角色权限</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
